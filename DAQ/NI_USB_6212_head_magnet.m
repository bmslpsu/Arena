function [s,devices] = NI_USB_6212_head_magnet(rate,AI,AO)
%% NI_USB_6212_head_magnet: creates DAQ session object
%   INPUTS:
...
chNames = {'Trigger','Pat x-pos','Pat y-pos','L-WBA','R-WBA','WB-Freq','PWM'};
